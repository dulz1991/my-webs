package com.demo.my.backend.ueditor;
...
public class UeditorActionEnter extends ActionEnter {
	...
	private static final Logger logger = LoggerFactory.getLogger(UeditorActionEnter.class);
                   ...
                   case 0: 
                    ...
                    case 4:
                        ...
                        try {
                        	...
                        	Map<String, Object> retMap = imgUploadService.uploadCodeImage(request);
