...
public class MD5Util {
	...
	public static void main(String[] args) {
		...
		String encode = encoderMd5.encode("111");
		...
		/*
		 * MD5Util encoderSha = new MD5Util(salt, "SHA"); String pass2 =
		 * encoderSha.encode("test"); System.out.println(pass2); boolean
		 * passwordValid2 =
		 * encoderSha.isPasswordValid("1e4346dcb54c1444e91668e04b8ca4f74f42958e"
		 * , "test"); System.out.println(passwordValid2);
		 */
	}
