	...
	var ms = {
		...
		fillHtml:function(obj,args){
			return (function(){
				...
				//涓婁竴椤�
				if(args.current > 1){
					obj.append('<a href="javascript:;" class="prevPage" onClick="'+args.fnName+'('+(args.current-1)+')">Prev</a>');
				}else{
					obj.remove('.prevPage');
				...
				if(args.current < args.pageCount){
					obj.append('<a href="javascript:;" class="nextPage" onClick="'+args.fnName+'('+(args.current+1)+')">Next</a>');
				}else{
					obj.remove('.nextPage');
