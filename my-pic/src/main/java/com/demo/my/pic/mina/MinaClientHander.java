...
public class MinaClientHander implements IoHandler {
	...
	@Override
	public void messageReceived(IoSession message, Object arg1) throws Exception {
		// TODO Auto-generated method stub
		System.out.println("client接受信息:"+message.toString());  
	}

	@Override
	public void messageSent(IoSession message, Object arg1) throws Exception {
		// TODO Auto-generated method stub
