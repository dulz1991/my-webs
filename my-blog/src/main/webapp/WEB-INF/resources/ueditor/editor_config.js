...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/upload/doImgUpload"             //图片上传提交地址
        //,imagePath:"/demo/upload/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imagePath:"http://my.demo/upload/img/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
